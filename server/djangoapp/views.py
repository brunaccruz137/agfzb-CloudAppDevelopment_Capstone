...
def get_dealer_details(request, id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://us-east.functions.appdomain.cloud/api/v1/web/Amabra_djangoserver-space/dealership-package/get_dealerships"
        dealer = get_dealer_by_id_from_cf(dealer_url, id=id)
        context["dealer"] = dealer
        
    
        review_url = "https://us-east.functions.appdomain.cloud/api/v1/web/Amabra_djangoserver-space/dealership-package/get_review"
        reviews = get_dealer_reviews_from_cf(review_url, dealership=id)
